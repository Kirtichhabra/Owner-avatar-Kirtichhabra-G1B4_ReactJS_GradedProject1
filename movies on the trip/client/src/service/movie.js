...
// it provides the service means the url for each one function on the top in tab 
// we are using post which add the movie in it and delete it delete the movie in it